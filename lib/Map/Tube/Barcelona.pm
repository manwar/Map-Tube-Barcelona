...
$Map::Tube::Barcelona::VERSION   = '0.17';
...
to be installed.
    ...
    print $IMAGE decode_base64($metro->as_image($line));
    close($IMAGE);

The L<L3 Line|https://raw.githubusercontent.com/Manwar/Map-Tube-Barcelona/master/maps/L3.png>
